...
This function produces a table if counts and proportions of every category in a categorical feature by the grouping variable. If specified in parameterization, the function will also produce barcharts illustrating the proportion of the grouping levels in each category within a feature. 
...
These following function is useful for generating reports based if one with working within Databricks Notebooks and filesystem.
